...
$(document).ready(function(){
    $('.alloy-header__toggler').on('click', function(){
        ...
        $('.alloy-header__nav').hasClass('alloy-header__nav-active') ? toggle = true : toggle = false
...
$(document).ready(function(){
    $('.alloy-header__search a').on('click', function(){
        $('.alloy-header__search-block').toggleClass('alloy-header__search-block_active')
    })

    $('.alloy-header__search-block svg').on('click', function(){
        $(this).parents('.alloy-header__search-block').attr('class', 'alloy-header__search-block')
    })
})
...
$(document).ready(function(){
    $('.alloy-header__lang').on('click', function(){
        $('.alloy-header__lang-block').toggleClass('alloy-header__lang-block_active')
    })
    ...
    $('.alloy-header__lang-block span').each(function(){
        $(this).on('click', function(){
            ...
            setTimeout(()=>{
                $('.alloy-header__lang-block').removeClass('alloy-header__lang-block_active')
            },500)
        })
    })
